...
function register_ekko_scripts() {
    wp_register_script('ekko', 'https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js', 'jquery', 'false', true);
    wp_enqueue_script('ekko');
}
add_action( 'wp_enqueue_scripts', 'register_ekko_scripts' );

function register_ekko_styles() {
    wp_register_style('ekko', 'https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.css' );
    wp_enqueue_style('ekko');
}
add_action( 'wp_enqueue_scripts', 'register_ekko_styles' );
...
/****************************************************************************
* Sobre mim > Exposições | Repeatable Fields
****************************************************************************/
...
$fields = array(
    ...
    //     'id'    => $prefix.'intro', // field id and name
    //     'type'  => 'textarea' // type of field
    // ),
    array( // Repeatable & Sortable Text inputs
        // 'label' => 'Data + texto sobre', // <label>
        'desc'  => 'Clique no (+) para adicionar mais Exposições .', // description
        ...
        'repeatable_fields' => array ( // array of fields to be repeated
            array( // Text Input
                'label' => 'Data', // <label>
                'desc'  => 'Insira o(s) ano(s) de realização da Expo.', // description
                'id'    => 'nome', // field id and name
                'type'  => 'text' // type of field
            ),    
            array( // Text Input
                'label' => 'Texto', // <label>
                'desc'  => 'Digite ou insira o conteúdo de texto referente à exposição.', // description
                'id'    => 'link', // field id and name
                'type'  => 'textarea' // type of field
            )
        )
    )
);
$sample_box = new custom_add_meta_box( 'sample_box', 'Exposições', $fields, 'sobre_mim', true );
